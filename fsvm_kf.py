# -*- coding: utf-8 -*-
"""
Created on Tue Jun 25 12:47:00 2019

@author: vb

    SONAR
link=https://www.openml.org/d/40
...
for  s in range(10):
    ...
    scores_fsvm.append(metrics.accuracy_score(y_test,Y))
   
acc_mean_svm=np.mean(scores_svm)
acc_sd_svm=np.std(scores_svm)

acc_mean_fsvm=np.mean(scores_fsvm)
acc_sd_fsvm=np.std(scores_fsvm)

print('---------SONAR DATASET-----------',end='\n\n')

print('SVM Accuracy Mean : ',acc_mean_svm,end='\n')    
print('SVM Accuracy Standard Deviation : ',acc_sd_svm,end='\n\n')


print('KFCM-FSVM Accuracy Mean : ',acc_mean_fsvm,end='\n')    
print('KFCM-FSVM Accuracy Standard Deviation : ',acc_sd_fsvm,end='\n\n')
