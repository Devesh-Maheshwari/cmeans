# -*- coding: utf-8 -*-
"""
Created on Wed Jun 26 14:14:24 2019
...
c=[0.625,0.05,1.0,8.0,64.0,0.01,2.0,10.0,5.00,0.25] 
         
#SVM model
#Cross-Validation

clf=svm.SVC(kernel='rbf',C=0.05,gamma='scale')
...
for train_index,test_index in kfold.split(x):
    ...
    C=0.00625 #regularization parameter
