# -*- coding: utf-8 -*-
"""
Created on Tue Jun 25 12:39:13 2019

@author: vb

BUPA
link=https://archive.ics.uci.edu/ml/datasets/liver+disorders
...
for  s in range(10):
    ...
    x_train,x_test,y_train,y_test=train_test_split(ctr,y,test_size=0.33)
