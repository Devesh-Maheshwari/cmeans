# -*- coding: utf-8 -*-
"""
Created on Tue Jun 25 10:08:32 2019

@author: vb

link=https://www.openml.org/d/182
"""
...
for  s in range(10):
    ...
    x_train,x_test,y_train,y_test=train_test_split(ctr,y,test_size=0.43)
    ...
    h2=np.asarray((cvx_Si*C))                            #Si*C
    #np.concatenate((a,b[:,None]),axis=1
    h = matrix(np.column_stack((h1,h2)))
